...
router.get("/", async (req, res) => {
    try {
        const { difficulty, topic, search, page = "1", limit = "20", sortBy = "title" } = req.query;
...
router.post("/", authenticateToken, async (req, res) => {
    try {
        ...
        const { title, difficulty, description, inputFormat, outputFormat, timeLimit, memoryLimit, topics, knowledgeComponents, constraints, testCases } = req.body;
